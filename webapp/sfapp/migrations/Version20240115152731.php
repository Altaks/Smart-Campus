 ...
 */
final class Version20240115152731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_travaux (id INT AUTO_INCREMENT NOT NULL, salle_id INT NOT NULL, systeme_acquisition_id INT DEFAULT NULL, type VARCHAR(12) NOT NULL, terminee TINYINT(1) NOT NULL, date DATETIME NOT NULL, email_demandeur VARCHAR(255) DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, INDEX IDX_5CD34834DC304035 (salle_id), INDEX IDX_5CD348343572D180 (systeme_acquisition_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE salle (id INT AUTO_INCREMENT NOT NULL, systeme_acquisition_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, orientation VARCHAR(2) NOT NULL, nombre_fenetre INT NOT NULL, nombre_porte INT NOT NULL, contient_pc TINYINT(1) NOT NULL, batiment VARCHAR(30) DEFAULT NULL, UNIQUE INDEX UNIQ_4E977E5C6C6E55B5 (nom), UNIQUE INDEX UNIQ_4E977E5C3572D180 (systeme_acquisition_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE seuil (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, valeur INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
